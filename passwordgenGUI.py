...
screen = Tk()
screen.title("Password Generator @tapgo416")
...
t1=Label(screen,text='Automatic Password Generator',font=('Arial',25),fg='white',background ="black")
t1.place(x=125,y=20)

t2=Label(screen,text='Password:',font=('Arial',14),fg='white',background ="black")
t2.place(x=145,y=90)

il=Entry(screen,font=('Arial',14),textvariable=sc1)
il.place(x=240,y=90)

t3=Label(screen,text='Length: ',font=('Arial',14),fg='white',background ="black")
t3.place(x=145,y=120)

t4=Label(screen,text='Strength:',font=('Arial',14),fg='white',background ="black")
